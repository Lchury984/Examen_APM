...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/asesor/contrataciones` | `/asesor/dashboard` | `/asesor/plan-form` | `/login` | `/perfil` | `/register` | `/reset-password` | `/usuario/contrataciones` | `/usuario/home`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/chat/${SingleRoutePart<T>}` | `/planes/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/chat/[id]` | `/planes/[id]`;
